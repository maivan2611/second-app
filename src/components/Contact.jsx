            ...
            <div className='grid grid-cols-5 mx-[79px]'>
                <div className='col-span-3 mx-[15px]' >
                    ...
                    <div>
                        ...
                        <textarea className='resize-y overflow-auto mb-2 text-sm leading-[21px] py-[11px] px-5 text-[#55595c] border border-[#e1e1e1] block w-[100%] focus:outline-none' type="text" name='content' placeholder='Nội dung(*)'></textarea>
                        <a href="" className='text-[12px] text-white font-normal leading-2.5 p-2.5 bg-redDe min-w-[100px] uppercase boder hover:text-[#252525] hover:bg-white hover:border-redDe'>
                            <i className="fa fa-paper-plane-o pr-[5px]" aria-hidden="true"></i>
                            Gửi liên hệ
                        </a>
                    </div>
                </div>
